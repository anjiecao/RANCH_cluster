...
trial_info="RANCH_cluster/sim_info/trial_info/stimulus_type/adults/trial_info.csv"
embedding_info="RANCH_cluster/sim_info/embeddings/stimulus_type/adults/resnet_pa_unscaled.csv"

param_dir=$project_path/MIT_tools/test_param_dir
